...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Les lignes de langue suivantes sont utilisées pour échanger nos attributs de remplacement
    | avec quelque chose de plus convivial pour le lecteur tel que "Adresse e-mail" à la place de "email".
