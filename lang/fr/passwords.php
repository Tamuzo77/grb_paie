...
return [
    ...
    | données par le gestionnaire de mots de passe pour une tentative de réinitialisation
    | de mot de passe a échoué, comme pour un jeton invalide ou un nouveau mot de passe invalide.
    |
    */
