...
<table>
    <thead >
        <tr>
            ...
            <td style="height:50px;border:2px solid #3498db;vertical-align:middle;font-weight:bold;text-align:center;" colspan="14">REPUBLIQUE DU BENIN</td>
        </tr>
        <tr>
            <td style="height:35px"></td>
...
{{--        </tr>--}}
        <tr class="">
            ...
            <td style="background-color: #3498db;color: #ffffff;height:35px;vertical-align:middle;font-weight:bold;" colspan="5">Cotonou Rép.Du Bénin</td>
        </tr>
        <tr>
            <td style="height:35px"></td>
    ...
    <tr class="">
        ...
        <td style="background-color: #3498db;color: #ffffff;height:50px;vertical-align:middle;font-weight:bold;" colspan="10">Eléments</td>
        <td style="background-color: #3498db;color: #ffffff;height:50px;vertical-align:middle;font-weight:bold;text-align:center" colspan="4">Montants</td>
    </tr>
    <tr>
        <td style="height:35px"></td>
    ...
    <tr>
        <td style="height:35px"></td>
        <td style="height:35px;vertical-align:middle;border:2px solid #3498db;font-weight:bold" colspan="14">MODE DE REGLEMENT DE:</td>
    </tr>
    <tr>
        <td style="height:35px"></td>
    ...
    <tr>
        <td style="height:50px"></td>
        <td style="height:50px;vertical-align:middle;border:2px solid #3498db;font-weight:bold;text-align:center;" colspan="14">DANS VOTRE INTERET ET POUR VALIDER VOS DROITS, VEILLER CONSERVER CETTE FICHE DE PAIE SANS LIMITATION DE DUREE</td>
    </tr>
    <tr>
        <td style="height:50x;"></td>
        <td style="height:50px;vertical-align:middle;border:2px solid #3498db" colspan="9"></td>
        <td style="height:50px;vertical-align:middle;border:2px solid #3498db;text-align:center" colspan="5">La Directrice Générale</td>
    </tr>
    <tr>
        <td style="height:35px"></td>
        <td style="height:35px;vertical-align:middle;border:2px solid #3498db" colspan="14" class='py-3'></td>
